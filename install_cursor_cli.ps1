...
TEMP_EXTRACT_DIR="$HOME/.local/share/cursor-agent/versions/.tmp-2025.08.08-f57cb59-$(date +%s)"
...
DOWNLOAD_URL="https://downloads.cursor.com/lab/2025.08.08-f57cb59/${OS}/${ARCH}/agent-cli-package.tar.gz"
...
FINAL_DIR="$HOME/.local/share/cursor-agent/versions/2025.08.08-f57cb59"
rm -rf "${FINAL_DIR}"
...
ln -s ~/.local/share/cursor-agent/versions/2025.08.08-f57cb59/cursor-agent ~/.local/bin/cursor-agent
